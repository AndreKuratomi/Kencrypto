...
<p>A aplicação <b>KenCrypto</b> consiste, como o próprio nome diz, numa refatoração da aplicação do desenvolvedor Alan Cesar Pires (original <b>[aqui](https://coinmarketcap.com/api/)</b>) na qual também foi acrescentado o gerenciamento de rotas e a aplicação de testes em Jest.</p>
...
<br>
<h5>1. Fazer o clone do reposítório Users service na sua máquina pelo terminal do computador ou pelo do IDE:</h5>
